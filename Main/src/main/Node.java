...
class Node {
    ...
    public Node getCar() {
        System.out.println("Cannot use getCar() on a Node object, only on a Cons object.");
        return null;
    }

    public Node getCdr() {
        System.out.println("Cannot use getCdr() on a Node object, only on a Cons object.");
        return null;
    }

    public void setCar(Node a) {
        System.out.println("Cannot use setCar() on a Node object, only on a Cons object.");
    }

    public void setCdr(Node d) {
        System.out.println("Cannot use setCdr() on a Node object, only on a Cons object.");
    }
}
